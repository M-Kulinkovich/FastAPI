...
from src.config import USER_DB, PASS_DB, HOST_DB, NAME_DB, PORT_DB
...
config.set_section_option(section, 'PASS_DB', PASS_DB)
config.set_section_option(section, 'HOST_DB', HOST_DB)
config.set_section_option(section, 'PORT_DB', PORT_DB)
